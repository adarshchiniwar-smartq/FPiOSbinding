...
@class NSString;
@protocol iFCCOperationIdentifier;
@protocol POSResponse;
@protocol DeviceBatteryStatus;
@protocol CardReadResponse;
@protocol iFCCCardReaderDeviceOptions;

SWIFT_CLASS_NAMED("DotnetNewBinding")
@interface DotnetNewBinding : NSObject <AttachDeviceDelegate, LaneStatusDelegate, iFCCInitializationDelegate, iFCCLaneDelegate>
