...
#ifndef FPPOICORE_SWIFT_H
#define FPPOICORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FPPOICore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9FPPOICore20ByteArrayInputStream")
@interface ByteArrayInputStream : NSInputStream
...
/// returns true if the stream has bytes available or if it impossible to tell without actually doing the read.
...
SWIFT_CLASS("_TtC9FPPOICore17EmvClessXmlParser")
@interface EmvClessXmlParser : NSObject
...
@interface EmvClessXmlParser (SWIFT_EXTENSION(FPPOICore)) <NSXMLParserDelegate>
...
SWIFT_CLASS("_TtC9FPPOICore19EmvContactXmlParser")
@interface EmvContactXmlParser : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@interface EmvContactXmlParser (SWIFT_EXTENSION(FPPOICore)) <NSXMLParserDelegate>
- (void)parserDidStartDocument:(NSXMLParser * _Nonnull)parser;
- (void)parserDidEndDocument:(NSXMLParser * _Nonnull)parser;
- (void)parser:(NSXMLParser * _Nonnull)parser didStartElement:(NSString * _Nonnull)elementName namespaceURI:(NSString * _Nullable)namespaceURI qualifiedName:(NSString * _Nullable)qName attributes:(NSDictionary<NSString *, NSString *> * _Nonnull)attributeDict;
- (void)parser:(NSXMLParser * _Nonnull)parser didEndElement:(NSString * _Nonnull)elementName namespaceURI:(NSString * _Nullable)namespaceURI qualifiedName:(NSString * _Nullable)qName;
